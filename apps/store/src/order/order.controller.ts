...
@ApiExtraModels(ProductDoesNotExistError, ProductSizeDoesNotExistError)
@ApiTags("Orders")
@Controller("orders")
  ...
  @ApiResponse({
    ...
    content: {
      "application/json": {
        schema: {
          oneOf: [
            { $ref: getSchemaPath(ProductDoesNotExistError) },
            { $ref: getSchemaPath(ProductSizeDoesNotExistError) },
          ],
        },
        examples: {
          productNotFound: {
            ...
            value: {
              message: "Product with id cm7z5tnsw00it9lsvax78ti7c not found",
          ...
          productSizeNotFound: {
            ...
            value: {
              message:
                "Product size with id cm7z5tnsw00it9lsvax78ti7c not found",
              errorCode: "PRODUCT_SIZE_NOT_FOUND",
            },
          },
          bodyBadRequest: {
            ...
            value: {
              ...
              cityRef: [
                "cityRef should not be empty",
                "cityRef must be a string",
              ],
              warehouseRef: [
